...
// robot proxy key.
std::string ROBOT_PROXY_POS_KEY = "robot::proxy::ee::target_pose";
std::string ROBOT_PROXY_ROT_KEY = "robot::proxy::ee::target_rotation";
std::string HAPTIC_PROXY_POS_KEY = "device::proxy::target_pose";
std::string HAPTIC_PROXY_ROT_KEY = "device::proxy::target_pose";
